...
import com.example.lenovo.seninfikrin.Model.Category;
import com.example.lenovo.seninfikrin.ViewHolder.CategoryViewHolder;
            ...
            protected void populateViewHolder(CategoryViewHolder viewHolder, final Category model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isShortClick) {
                        Intent anketBaslat = new Intent(getActivity(),Start.class);
                        Common.kategori=adapter.getRef(position).getKey();
                        startActivity(anketBaslat);
                    }
                });
            }
        };
